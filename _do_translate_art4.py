...
with open('_art4_translations.json', 'r', encoding='utf-8') as f:
...
for block in translated['blocks']:
    for el in block.get('elements', []):
        ...
        if original in translations:
            el['content'] = translations[original]
            if translations[original] != original:
                translated_count += 1
            else:
                kept_count += 1
            ...
            # Try to catch remaining Chinese
