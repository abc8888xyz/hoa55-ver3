#!/usr/bin/env python3
"""Translate all Chinese text in original_blocks.json to Vietnamese, then update Lark doc."""
import json
import copy
import sys

# Translation mapping: Chinese -> Vietnamese
# Only translate Chinese text, keep English/Korean/emoji as-is
TRANSLATIONS = {
    ...
    ""参考能力"是最大亮点": "\"Khả năng tham chiếu\" là điểm nổi bật lớn nhất",
    "📷 参考图像可精准还原画面构图、角色细节": "📷 Hình ảnh tham chiếu có thể tái tạo chính xác bố cục hình ảnh, chi tiết nhân vật",
    "🎥 参考视频支持镜头语言、复杂的动作节奏、创意特效的复刻": "🎥 Video tham chiếu hỗ trợ ngôn ngữ ống kính, nhịp độ động tác phức tạp, tái tạo hiệu ứng sáng tạo",
    "⏱ 视频支持平滑延长与衔接，可按用户提示生成连续镜头，不止生成，还能"接着拍"": "⏱ Video hỗ trợ kéo dài mượt mà và nối tiếp, có thể tạo cảnh quay liên tục theo gợi ý người dùng, không chỉ tạo mới mà còn \"quay tiếp\"",
    "✂️ 编辑能力同步增强，支持对已有视频进行角色更替、删减、增加": "✂️ Khả năng chỉnh sửa được tăng cường đồng bộ, hỗ trợ thay thế, cắt giảm, thêm nhân vật trong video có sẵn",
    ...
    "核心维度": "Thông số cốt lõi",
    "图片输入": "Đầu vào hình ảnh",
    "≤ 9 张": "≤ 9 tấm",
    "视频输入": "Đầu vào video",
    "≤ 3 个，总时长不超过15s": "≤ 3 file, tổng thời lượng không quá 15s",
    "（有参考视频会贵一点哦）": "(Có video tham chiếu sẽ tốn hơn một chút nhé)",
    "音频输入": "Đầu vào âm thanh",
    "支持 MP3 上传，数量≤ 3 个，总时长不超过15s": "Hỗ trợ tải lên MP3, số lượng ≤ 3 file, tổng thời lượng không quá 15s",
    "文本输入": "Đầu vào văn bản",
    "自然语言": "Ngôn ngữ tự nhiên",
    "生成时长": "Thời lượng tạo",
    "≤ 15s，可自由选择4-15s": "≤ 15s, có thể tự do chọn 4-15s",
    "声音输出": "Đầu ra âm thanh",
    "自带音效/配乐": "Tích hợp sẵn hiệu ứng âm thanh/nhạc nền",
    "交互限制：": "Giới hạn tương tác:",
    "目前支持的混合输入总上限是 12 个文件": "Hiện tại tổng giới hạn đầu vào hỗn hợp là 12 file",
    "。建议优先上传对画面或节奏影响最大的素材，合理分配不同模态的文件数量": ". Khuyến nghị ưu tiên tải lên tài liệu có ảnh hưởng lớn nhất đến hình ảnh hoặc nhịp điệu, phân bổ hợp lý số lượng file của các phương thức khác nhau",
    ...
    "入口，": "đầu vào,",
    "智能多帧和主体参考无法选中": "Đa khung hình thông minh và tham chiếu chủ thể không thể chọn",
    "。若你只上传首帧图 + prompt，可走首尾帧入口；如需多模态（图、视频、音频、文本）组合输入，则需进入全能参考入口": ". Nếu bạn chỉ tải lên ảnh khung hình đầu + prompt, có thể dùng đầu vào khung hình đầu cuối; nếu cần kết hợp đa phương thức (ảnh, video, âm thanh, văn bản), thì cần vào đầu vào tham chiếu toàn năng",
    "当前支持的交互方式是通过"@素材名"来指定每个图片、视频、音频的用途，例如：@图片1 作为首帧，@视频1 参考镜头语言，@音频1 用于配乐": "Cách tương tác hiện tại là thông qua \"@tên tài liệu\" để chỉ định mục đích của mỗi hình ảnh, video, âm thanh, ví dụ: @Ảnh1 làm khung hình đầu, @Video1 tham chiếu ngôn ngữ ống kính, @Âm thanh1 dùng làm nhạc nền",
    "主界面：": "Giao diện chính:",
    "入口：Seedance 2.0 - 全能参考/首尾帧": "Đầu vào: Seedance 2.0 - Tham chiếu toàn năng/Khung hình đầu cuối",
    "唤起本地文件弹窗": "Mở cửa sổ chọn file nội bộ",
    "选定文件，添加至输入框": "Chọn file, thêm vào ô nhập liệu",
    ...
    "方法2：点击参数工具"@"唤起参考调用": "Cách 2: Nhấp vào công cụ \"@\" để gọi tham chiếu",
    "点击"@"": "Nhấp \"@\"",
    "上传素材后，": "Sau khi tải lên tài liệu,",
    "图片、视频、音频": "hình ảnh, video, âm thanh",
    "都支持": "đều hỗ trợ",
    "悬停预览": "xem trước khi di chuột",
    "下面是一些不同场景下的用法和玩法，帮助你更好地理解 Seedance 2.0 在生成质量上、控制能力和创意表现上的升级。如果你还不知道从哪开始，不如先看看这些例子，激发灵感～": "Dưới đây là một số cách sử dụng và chơi trong các tình huống khác nhau, giúp bạn hiểu rõ hơn về sự nâng cấp của Seedance 2.0 trong chất lượng tạo nội dung, khả năng kiểm soát và biểu hiện sáng tạo. Nếu bạn chưa biết bắt đầu từ đâu, hãy xem qua các ví dụ này để lấy cảm hứng~",
    "Seedance 2.0 能力 / 提升预览": "Seedance 2.0 Năng lực / Xem trước nâng cấp",
    "基础能力显著增强：更稳、更顺、更像真的！ ": "Năng lực cơ bản tăng cường đáng kể: Ổn định hơn, mượt hơn, giống thật hơn! ",
    "不只是多模态，Seedance 2.0 在基础层面显著增强，": "Không chỉ là đa phương thức, Seedance 2.0 được tăng cường đáng kể ở tầng cơ bản,",
    "物理规律更合理": "Quy luật vật lý hợp lý hơn",
    "动作表现更自然流畅": "Biểu hiện động tác tự nhiên mượt mà hơn",
    "指令理解更精准": "Hiểu lệnh chính xác hơn",
    "风格保持更稳定": "Giữ phong cách ổn định hơn",
    "，不仅能稳定完成复杂动作、连续运动等高难度生成任务，也让整体视频效果更真实、更顺滑，是一次底层能力的全面进化！": ", không chỉ hoàn thành ổn định các nhiệm vụ tạo nội dung khó như động tác phức tạp, chuyển động liên tục, mà còn làm hiệu ứng video tổng thể chân thực hơn, mượt mà hơn — đây là một cuộc tiến hóa toàn diện ở tầng nền tảng!",
    "Case：": "Ví dụ:",
    "女孩在优雅的晒衣服，晒完接着在桶里拿出另一件，用力抖一抖衣服。": "Cô gái đang phơi quần áo một cách duyên dáng, phơi xong lại lấy ra một chiếc khác từ thùng, rũ mạnh chiếc áo.",
    "超强真实感": "Cảm giác chân thực siêu mạnh",
    ...
    "镜头跟随黑衣男子快速逃亡，后面一群人在追，镜头转为侧面跟拍，人物惊慌撞倒路边的水果摊爬起来继续逃，人群慌乱的声音。": "Ống kính theo dõi người đàn ông áo đen chạy trốn nhanh chóng, phía sau một đám người đuổi theo, ống kính chuyển sang quay bám từ bên cạnh, nhân vật hoảng loạn đâm đổ quầy trái cây bên đường rồi đứng dậy tiếp tục chạy, tiếng đám đông hỗn loạn.",
    "多模态全面升级：视频创作进入"自由组合"时代！": "Đa phương thức nâng cấp toàn diện: Sáng tạo video bước vào thời đại \"tự do kết hợp\"!",
    ...
    "只要提示词写得清楚": "chỉ cần prompt viết rõ ràng",
    "，模型都能理解。": ", mô hình đều có thể hiểu.",
    "Seedance 2.0 = 多模态参考能力（可参考万物） + 强创意生成 + 指令响应精准（理解力很棒）": "Seedance 2.0 = Khả năng tham chiếu đa phương thức (có thể tham chiếu mọi thứ) + Tạo nội dung sáng tạo mạnh mẽ + Phản hồi lệnh chính xác (khả năng hiểu tuyệt vời)",
    "用自然语言描述你想要的画面和动作就可以啦，明确是参考，还是编辑～素材多的时候，建议你多检查一下各个 @对象有没有标清楚，别把图、视频、角色搞混了哦": "Chỉ cần dùng ngôn ngữ tự nhiên mô tả hình ảnh và động tác bạn muốn là được, nói rõ là tham chiếu hay chỉnh sửa~ Khi có nhiều tài liệu, khuyến nghị kiểm tra lại xem các @đối tượng đã ghi rõ chưa, đừng nhầm lẫn giữa ảnh, video và nhân vật nhé",
    "特殊使用方式（不设限，仅供参考）：": "Cách sử dụng đặc biệt (không giới hạn, chỉ mang tính tham khảo):",
    "有首帧/尾帧图？还想参考视频动作？": "Có ảnh khung hình đầu/cuối? Còn muốn tham chiếu động tác video?",
    " → 提示词中写清楚，如："@图1为首帧，参考@视频1的打斗动作"": " → Viết rõ trong prompt, ví dụ: \"@Ảnh1 làm khung hình đầu, tham chiếu động tác đánh nhau của @Video1\"",
    "想延长一个已有的视频？": "Muốn kéo dài một video có sẵn?",
    " → 说明延长时间，如"将@视频1延长 5s"，": " → Nêu rõ thời gian kéo dài, ví dụ \"Kéo dài @Video1 thêm 5s\",",
    "注意：此时选择的生成时长应为"新增部分"的时长": "Lưu ý: Lúc này thời lượng tạo được chọn phải là thời lượng của \"phần mới thêm\"",
    "（例如延长 5s，生成长度也选 5s": "(Ví dụ kéo dài 5s, thời lượng tạo cũng chọn 5s",
    "想融合多个视频？": "Muốn kết hợp nhiều video?",
    " → 提示词中说明合成逻辑，如："我要在@视频1和@视频2之间加一个场景，内容为xxx"": " → Nêu rõ logic ghép nối trong prompt, ví dụ: \"Tôi muốn thêm một cảnh giữa @Video1 và @Video2, nội dung là xxx\"",
    "没音频素材？可以直接参考视频里的声音": "Không có tài liệu âm thanh? Có thể trực tiếp tham chiếu âm thanh trong video",
    "想生成连续动作？": "Muốn tạo động tác liên tục?",
    " → 可以在提示词中加入连续性描述，如："角色从跳跃直接过渡到翻滚，保持动作连贯流畅"@图1@图2@图3...": " → Có thể thêm mô tả liên tục trong prompt, ví dụ: \"Nhân vật từ nhảy chuyển thẳng sang lăn, giữ động tác liền mạch mượt mà\" @Ảnh1@Ảnh2@Ảnh3...",
    "那些一直很难做的视频问题，现在真的能搞定了！": "Những vấn đề video khó giải quyết bấy lâu, giờ thực sự đã xử lý được!",
    "做视频总会碰到一些让人头疼的地方：比如人脸换了、动作不像、视频延长不自然、改着改着整个节奏都变了……这次多模态能把这些"老大难"问题一口气解决了，下面就是具体的使用案例👇": "Làm video luôn gặp phải những điểm đau đầu: ví dụ khuôn mặt bị đổi, động tác không giống, kéo dài video không tự nhiên, sửa mãi cả nhịp điệu đều thay đổi... Lần này đa phương thức có thể giải quyết hết những vấn đề \"nan giải\" này trong một lần, dưới đây là các ví dụ sử dụng cụ thể👇",
    "一致性全面提升": "Tính nhất quán nâng cấp toàn diện",
    "你可能遇到过这些烦恼：画面里人物前后长得不一样、商品细节丢了、小字模糊、场景跳变、镜头风格无法统一……这些在创作中常见的一致性问题，现在在 2.0 中都能被解决。从人脸到服装，再到字体细节，整体一致性更稳、更准": "Bạn có thể đã gặp những phiền toái này: nhân vật trong hình trước sau trông khác nhau, chi tiết sản phẩm bị mất, chữ nhỏ mờ, cảnh nhảy đột ngột, phong cách ống kính không thể thống nhất... Những vấn đề nhất quán thường gặp trong sáng tạo, giờ đều có thể giải quyết trong 2.0. Từ khuôn mặt đến trang phục, cho đến chi tiết phông chữ, tính nhất quán tổng thể ổn định hơn, chính xác hơn",
    "生成结果": "Kết quả tạo",
    ...
    "参考 @视频1的所有转场和运镜，一镜到底，画面以棋局为起始，镜头左移，展示地板的黄色沙砾，镜头上移来到一个沙滩，沙滩上有足印，一个穿着白色素衣的女生在沙滩上渐行渐远，镜头切到空中的俯拍视角，海水在冲刷（不要出现人物），无缝渐变转场，冲刷的海浪变成飘动的窗帘，镜头拉远，展示女孩的面部特写，一镜到底": "Tham chiếu tất cả chuyển cảnh và chuyển động ống kính của @Video1, quay liền một mạch, hình ảnh bắt đầu từ bàn cờ, ống kính dịch trái, hiển thị cát vàng trên sàn, ống kính di chuyển lên đến một bãi biển, trên bãi biển có dấu chân, một cô gái mặc váy trắng trên bãi biển dần xa dần, ống kính chuyển sang góc quay từ trên cao, nước biển đang xô bờ (không có nhân vật), chuyển cảnh hòa tan liền mạch, sóng biển xô bờ biến thành rèm cửa bay phất phơ, ống kính kéo xa, hiển thị cận cảnh khuôn mặt cô gái, quay liền một mạch",
    "0-2秒画面：快速四格闪切，红、粉、紫、豹纹四款蝴蝶结依次定格，特写缎面光泽与 "chéri" 品牌字样。画外音"Chéri 자석 리본으로 무궁무진한 아름다움을 연출해 보세요!"": "0-2 giây: Bốn khung hình cắt nhanh, bốn kiểu nơ đỏ, hồng, tím, da báo lần lượt đóng khung, cận cảnh độ bóng lụa sa-tanh và chữ thương hiệu \"chéri\". Giọng ngoài hình \"Chéri 자석 리본으로 무궁무진한 아름다움을 연출해 보세요!\"",
    "3-6秒画面：特写银色磁吸扣 "咔嗒" 吸合，再轻轻一拉分开，展示丝滑质感与便捷性。画外音"단 1초 만에 잠그고, 최고의 스타일을 완성하세요!"": "3-6 giây: Cận cảnh khóa từ tính bạc \"tách\" hít vào nhau, rồi nhẹ nhàng kéo ra, thể hiện chất cảm mượt mà và tính tiện lợi. Giọng ngoài hình \"단 1초 만에 잠그고, 최고의 스타일을 완성하세요!\"",
    "7-12 秒画面：快速切换佩戴场景：酒红款别在大衣领口，通勤氛围感拉满；粉色款绑在马尾，甜妹出街；紫色款系在包带，小众高级；豹纹款挂在西装领，辣妹气场全开。画外音"코트, 가방, 헤어 액세서리까지, 다재다능하고 개성 넘치는 스타일을 완성하세요!"": "7-12 giây: Cắt nhanh các cảnh đeo: Kiểu đỏ rượu cài ở cổ áo khoác, cảm giác đi làm đầy đủ; kiểu hồng buộc trên đuôi ngựa, gái ngọt ra phố; kiểu tím buộc trên dây đeo túi, độc đáo cao cấp; kiểu da báo treo trên cổ vest, phong thái gái cá tính toàn khai. Giọng ngoài hình \"코트, 가방, 헤어 액세서리까지, 다재다능하고 개성 넘치는 스타일을 완성하세요!\"",
    "13-15秒画面：四款蝴蝶结并排陈列，品牌名 "chéri, 당신에게 즉각적인 아름다움을 선사합니다!"": "13-15 giây: Bốn kiểu nơ bày cạnh nhau, tên thương hiệu \"chéri, 당신에게 즉각적인 아름다움을 선사합니다!\"",
    "对@图片2的包包进行商业化的摄像展示，包包的侧面参考@图片1，包包的表面材质参考@图片3，要求将包包的细节均有所展示，背景音恢宏大气，": "Quay trình diễn thương mại cho túi xách @Ảnh2, mặt bên của túi tham chiếu @Ảnh1, chất liệu bề mặt túi tham chiếu @Ảnh3, yêu cầu hiển thị tất cả chi tiết của túi, nhạc nền hoành tráng,",
    "把@图片1作为画面的首帧图，第一人称视角，参考@视频1的运镜效果，上方场景参考@图片2，左边场景参考@图片3，右边场景参考@图片4。": "Lấy @Ảnh1 làm khung hình đầu, góc nhìn thứ nhất, tham chiếu hiệu ứng chuyển động ống kính @Video1, cảnh phía trên tham chiếu @Ảnh2, cảnh bên trái tham chiếu @Ảnh3, cảnh bên phải tham chiếu @Ảnh4.",
    "高难度/可控的运镜和动作精准复刻": "Chuyển động ống kính và động tác có độ khó cao/có thể kiểm soát, tái tạo chính xác",
    "以前想让模型模仿电影里的走位、运镜或者复杂动作，要么写一堆细节提示词，要么干脆做不到。而现在，只需要上传一段参考视频，就可以了": "Trước đây muốn mô hình bắt chước di chuyển, chuyển động ống kính hoặc động tác phức tạp trong phim, hoặc phải viết hàng loạt prompt chi tiết, hoặc đơn giản là không làm được. Nhưng bây giờ, chỉ cần tải lên một đoạn video tham chiếu là được",
    "创意模版 / 复杂特效精准复刻": "Mẫu sáng tạo / Hiệu ứng phức tạp tái tạo chính xác",
    "不止能生图写故事，Seedance 2.0 还支持"照着模仿"——创意转场、广告成片、电影片段、复杂剪辑，只要你有参考图或视频，模型就能识别动作节奏、镜头语言、视觉结构，并精准复刻出来。不懂专业术语也没关系，写清楚你想参考的部分，比如"参考 @视频1 的节奏和运镜，@图1 的角色造型"，模型就能高质量生成属于你的版本。大胆试！它真的能做到": "Không chỉ tạo ảnh viết chuyện, Seedance 2.0 còn hỗ trợ \"bắt chước theo\" — chuyển cảnh sáng tạo, phim quảng cáo hoàn chỉnh, đoạn phim điện ảnh, biên tập phức tạp. Chỉ cần bạn có ảnh hoặc video tham chiếu, mô hình có thể nhận diện nhịp độ động tác, ngôn ngữ ống kính, cấu trúc thị giác và tái tạo chính xác. Không hiểu thuật ngữ chuyên ngành cũng không sao, viết rõ phần bạn muốn tham chiếu, ví dụ \"Tham chiếu nhịp điệu và chuyển động ống kính @Video1, tạo hình nhân vật @Ảnh1\", mô hình có thể tạo ra phiên bản chất lượng cao của riêng bạn. Cứ thử đi! Nó thực sự làm được",
    "模型的创意性、剧情补全能力": "Tính sáng tạo của mô hình, khả năng bổ sung cốt truyện",
    "视频延长": "Kéo dài video",
    ...
    "生成一个15秒的MV视频。关键词：稳重构图 / 轻推拉 / 低角度英雄感 / 纪实但高级A超广角建立镜头，低机位轻微仰拍，悬崖土路与复古旅行车占画面下三分之一，远处海面与地平线拉开空间，夕阳侧逆光体积光穿过尘粒，电影级构图，真实胶片颗粒，微风吹动衣角。": "Tạo một video MV 15 giây. Từ khóa: bố cục ổn định / đẩy kéo nhẹ / góc thấp cảm giác anh hùng / phong cách tài liệu nhưng cao cấp. Ống kính siêu rộng thiết lập cảnh, máy quay thấp hơi ngước lên, đường đất vách đá và xe du lịch cổ điển chiếm 1/3 dưới khung hình, mặt biển xa và đường chân trời mở rộng không gian, ánh hoàng hôn ngược bên sườn với tia sáng thể tích xuyên qua bụi, bố cục cấp điện ảnh, hạt phim thực, gió nhẹ thổi vạt áo.",
    ...
    "0-3秒：开头闹钟响起来，画面朦胧中出现画面1； ": "0-3 giây: Mở đầu đồng hồ báo thức kêu, trong hình ảnh mờ ảo xuất hiện Hình 1; ",
    "3-10秒：快速摇镜头，转向对面特写男人面部，男人无奈的叫女生起床，语气和音色参考@视频1； ": "3-10 giây: Ống kính quay nhanh, chuyển sang cận cảnh khuôn mặt người đàn ông đối diện, người đàn ông bất lực gọi cô gái dậy, giọng điệu và âm sắc tham chiếu @Video1; ",
    "10-12秒：女生撅着嘴躲进被子里面； ": "10-12 giây: Cô gái chu môi trốn vào chăn; ",
    "12-15秒：切换到男主全身，他叹着气说："真拿你没办法！"": "12-15 giây: Chuyển sang toàn thân nam chính, anh thở dài nói: \"Thật chẳng biết làm sao với em!\"",
    ...
    "切镜，镜头给到猴子。": "Cắt cảnh, ống kính chuyển sang con khỉ.",
    "他挠了挠头念念有词："没事……？我有事！孙儿叫我来买个奶茶，就叫个撒子霸王别姬嘛"": "Nó gãi đầu lẩm bẩm: \"Không sao...? Tôi có việc! Cháu tôi bảo tôi ra mua trà sữa, gọi cái gì Bá Vương Biệt Cơ đó\"",
    "用科普风格和音色，将": "Dùng phong cách và giọng khoa học phổ thông, diễn giải",
    "图片1": "Ảnh1",
    ...
    "镜头连贯性（一镜到底）更强": "Tính liền mạch ống kính (quay một mạch) mạnh hơn",
    "@图片1@图片2@图片3@图片4@图片5，一镜到底的追踪镜头，从街头跟随跑步者上楼梯、穿过走廊、进入屋顶，最终俯瞰城市。": "@Ảnh1@Ảnh2@Ảnh3@Ảnh4@Ảnh5, ống kính theo dõi quay một mạch, từ đường phố theo người chạy lên cầu thang, xuyên qua hành lang, vào mái nhà, cuối cùng nhìn xuống thành phố.",
    "以@图片1为首帧，画面放大至飞机舷窗外，一团团云朵缓缓飘至画面中，其中一朵为彩色糖豆点缀的云朵，始终在画面中居中，然后缓缓变形为@图片2的冰淇淋，镜头推远回到机舱内，坐在窗边的@图片3伸手从窗外拿进冰淇淋，吃了一口，嘴巴上沾满奶油，脸上洋溢出甜蜜的笑容，此时视频配音为@视频1.": "Lấy @Ảnh1 làm khung hình đầu, hình ảnh phóng to ra ngoài cửa sổ máy bay, từng đám mây từ từ trôi vào hình, trong đó có một đám mây điểm xuyết kẹo màu, luôn ở giữa hình, rồi từ từ biến hình thành kem @Ảnh2, ống kính kéo xa trở lại khoang máy bay, @Ảnh3 ngồi bên cửa sổ đưa tay lấy kem từ ngoài cửa sổ vào, cắn một miếng, miệng dính đầy kem, mặt rạng rỡ nụ cười ngọt ngào, lúc này lồng tiếng video là @Video1.",
    ...
    "@图片1@图片2@图片3@图片4@图片5，主观视角一镜到底的惊险过山车的镜头，过山车的速度越来越快。": "@Ảnh1@Ảnh2@Ảnh3@Ảnh4@Ảnh5, ống kính tàu lượn siêu tốc thót tim quay một mạch từ góc nhìn chủ quan, tốc độ tàu lượn ngày càng nhanh.",
    "视频编辑可用度高": "Tính khả dụng chỉnh sửa video cao",
    ...
    "颠覆@视频1的整个剧情": "Đảo ngược toàn bộ cốt truyện @Video1",
    "0–3秒画面：西装男坐在酒吧，神情冷静，手里轻晃酒杯。 镜头缓慢推进，光影高级、氛围严肃。 环境音低沉，西装男小声说"这单生意，很大。"": "0-3 giây: Người đàn ông vest ngồi trong quán bar, vẻ mặt bình tĩnh, tay nhẹ nhàng lắc ly rượu. Ống kính từ từ đẩy tới, ánh sáng cao cấp, bầu không khí nghiêm túc. Âm thanh môi trường trầm, người đàn ông vest nói nhỏ \"Thương vụ này, rất lớn.\"",
    "3–6秒画面：身后的女人表情紧张问"有多大？"西装男抬眼，压低声音："非常大。"镜头切手部特写——他把酒杯放下，气场拉满。": "3-6 giây: Người phụ nữ phía sau mặt căng thẳng hỏi \"Lớn đến mức nào?\" Người đàn ông vest ngước mắt, hạ giọng: \"Rất lớn.\" Ống kính cắt sang cận cảnh bàn tay — anh ta đặt ly rượu xuống, khí chất đầy ắp.",
    "6–9秒画面：突然西装男从桌下掏出—— 一大包体积夸张的零食礼包，"咚"的一声重重放在桌上。": "6-9 giây: Đột nhiên người đàn ông vest lấy ra từ dưới bàn — một gói quà đồ ăn vặt cỡ khổng lồ, \"bịch\" một tiếng đặt mạnh lên bàn.",
    "9–12秒画面：身后的女人原本放在腰间的手，肌肉从僵硬到松弛，整个人表情放松。画面氛围轻松起来。": "9-12 giây: Tay người phụ nữ phía sau vốn đặt ở eo, cơ bắp từ cứng nhắc dần thả lỏng, toàn bộ biểu cảm trở nên thoải mái. Bầu không khí hình ảnh nhẹ nhàng lên.",
    "13–15秒画面：西装男拿出一包零食给女人，镜头拉远展示酒馆全景，画面变得透明模糊—— 字幕弹出"再忙，也要记得吃点零食~"": "13-15 giây: Người đàn ông vest lấy ra một gói đồ ăn vặt đưa cho người phụ nữ, ống kính kéo xa hiển thị toàn cảnh quán bar, hình ảnh trở nên trong suốt mờ — phụ đề hiện lên \"Dù bận đến mấy, cũng nhớ ăn chút đồ ăn vặt nhé~\"",
    "视频1中的女主唱换成图片1的男主唱，动作完全模仿原视频，不要出现切镜，乐队演唱音乐。": "Thay nữ ca sĩ chính trong Video1 thành nam ca sĩ chính của Ảnh1, động tác hoàn toàn bắt chước video gốc, không cắt cảnh, ban nhạc biểu diễn.",
    "将视频1女人发型变成红色长发，图片1中的大白鲨缓缓浮出半个脑袋，在她身后。": "Đổi kiểu tóc người phụ nữ trong Video1 thành tóc dài đỏ, con cá mập trắng trong Ảnh1 từ từ nổi lên nửa đầu, ở phía sau cô ấy.",
    "视频1镜头右摇，炸鸡老板忙碌地将炸鸡递给排队的客户，用普通话说"做完他的，做你的，大家文明排队。"一说完，就去拿纸袋子去装炸鸡。特写展示老板拿印有图1的纸袋子，特写展示递给客户的手部特写。": "Video1 ống kính quay phải, ông chủ gà rán bận rộn đưa gà rán cho khách xếp hàng, nói bằng tiếng phổ thông \"Làm xong của anh ấy, rồi đến anh, mọi người xếp hàng văn minh.\" Nói xong liền đi lấy túi giấy đựng gà rán. Cận cảnh ông chủ cầm túi giấy in Ảnh1, cận cảnh đưa cho khách.",
    "可进行音乐卡点": "Có thể canh nhịp nhạc",
    "情绪演绎更好": "Diễn giải cảm xúc tốt hơn",
    "🏁 最后说两句": "🏁 Lời kết",
    "Seedance 2.0 的多模态能力正处于不断进化中，我们会持续更新能力、支持更多种输入组合方式。希望这份使用手册能帮你更自由地发挥创意！": "Khả năng đa phương thức của Seedance 2.0 đang không ngừng tiến hóa, chúng tôi sẽ liên tục cập nhật năng lực, hỗ trợ nhiều cách kết hợp đầu vào hơn. Hy vọng hướng dẫn sử dụng này giúp bạn tự do phát huy sáng tạo hơn!",
...
def translate_content(text):
    """Translate Chinese text to Vietnamese using the mapping."""
    if text in TRANSLATIONS:
        return TRANSLATIONS[text]
    # For texts not in mapping, keep as-is (likely English terms like prompt, img1, etc.)
    return text
...
def main():
    ...
    for block in translated['blocks']:
        for elem in block.get('elements', []):
            original = elem.get('content', '')
            if original.strip():
                new_content = translate_content(original)
    ...
    print(f"Translated {translated_count} text elements out of 206 total")
    print("Saved to translated_blocks.json")
